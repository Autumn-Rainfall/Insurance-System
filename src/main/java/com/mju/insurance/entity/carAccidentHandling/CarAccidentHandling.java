...
public class CarAccidentHandling {
	...
	public ArrayList<AccidentCar> getAccidentCars() { return accidentCars; }
	public void setAccidentCars(ArrayList<AccidentCar> accidentCars) { this.accidentCars = accidentCars; }
	public ArrayList<AccidentPerson> getAccidentPeople() { return accidentPeople; }
	public void setAccidentPeople(ArrayList<AccidentPerson> accidentPeople) { this.accidentPeople = accidentPeople; }
}
